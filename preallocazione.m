...
CD_memo = NaN(num_configurazioni, 1);
...
W_batt_memo = NaN(num_configurazioni, 1);
phi_ice_cl_memo = NaN(num_configurazioni, 1);
phi_ice_cr_memo = NaN(num_configurazioni, 1);
phi_ice_de_memo = NaN(num_configurazioni, 1);
